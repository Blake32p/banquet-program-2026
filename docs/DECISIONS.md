...
| D14 | Content for Volunteers of the Year and Outstanding Volunteers | IN PROGRESS | **Blake, 2026-09-23: volunteer names are coming.** Keep the “Volunteers of the Year” card (`#volunteers`) and its jump pill, and fill them in when the names arrive (the format is in `content/honorees.md`). Run of show v1 calls the stage segment “Campaign Volunteer Recognition” (Kathleen Callahan). | Blake |
