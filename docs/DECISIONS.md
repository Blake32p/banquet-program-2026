...
| D14 | Content for Volunteers of the Year and Outstanding Volunteers | OPEN | Names, citations, and whether to include a name list, as in 2025. **Run of show v1 calls the segment “Campaign Volunteer Recognition”** (Kathleen Callahan) and names no volunteers. Is that the same as the flyer’s “Volunteers of the Year”? If there are no individual honorees, remove the Volunteers placeholder card and its jump pill. | Committee |
| D15 | “Paid for by” line | OPEN | Ask the Chair or Treasurer. It's more relevant now that the program names a State Senate candidate as a presenter. | Committee |
| D16 | Closing page | ADOPTED | The last page of the Canva program (“Congratulations!” + the note from Karen and Kathleen) is included basically as-is, as **the end of the program**. It uses the original vector art and live text. | Blake, 2026-09-23 |
