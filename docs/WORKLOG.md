...
**Next step (exact):** Confirm the GitHub Pages deploy finished and the live site serves the redesign (check for `roll-title` in the HTML); then scroll the live page on an iPhone.
